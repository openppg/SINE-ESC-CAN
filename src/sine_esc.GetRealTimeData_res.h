...
#define SINE_ESC_GETREALTIMEDATA_RESPONSE_MAX_SIZE 33
#define SINE_ESC_GETREALTIMEDATA_RESPONSE_SIGNATURE (0x9AB6F8CCCBF6F016ULL)
#define SINE_ESC_GETREALTIMEDATA_RESPONSE_ID 211

#if defined(__cplusplus) && defined(DRONECAN_CXX_WRAPPERS)
class sine_esc_GetRealTimeData_cxx_iface;
#endif

struct sine_esc_GetRealTimeDataResponse {
#if defined(__cplusplus) && defined(DRONECAN_CXX_WRAPPERS)
    using cxx_iface = sine_esc_GetRealTimeData_cxx_iface;
#endif
    uint16_t recv_pwm;
    uint16_t comm_pwm;
    int32_t speed;
...
uint32_t sine_esc_GetRealTimeDataResponse_encode(struct sine_esc_GetRealTimeDataResponse* msg, uint8_t* buffer
#if CANARD_ENABLE_TAO_OPTION
    , bool tao
#endif
);
bool sine_esc_GetRealTimeDataResponse_decode(const CanardRxTransfer* transfer, struct sine_esc_GetRealTimeDataResponse* msg);

#if defined(CANARD_DSDLC_INTERNAL)
static inline void _sine_esc_GetRealTimeDataResponse_encode(uint8_t* buffer, uint32_t* bit_ofs, struct sine_esc_GetRealTimeDataResponse* msg, bool tao);
static inline bool _sine_esc_GetRealTimeDataResponse_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct sine_esc_GetRealTimeDataResponse* msg, bool tao);
void _sine_esc_GetRealTimeDataResponse_encode(uint8_t* buffer, uint32_t* bit_ofs, struct sine_esc_GetRealTimeDataResponse* msg, bool tao) {
    (void)buffer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
...
/*
 decode sine_esc_GetRealTimeDataResponse, return true on failure, false on success
*/
bool _sine_esc_GetRealTimeDataResponse_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct sine_esc_GetRealTimeDataResponse* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
...
struct sine_esc_GetRealTimeDataResponse sample_sine_esc_GetRealTimeDataResponse_msg(void);
#endif
#ifdef __cplusplus
} // extern "C"
