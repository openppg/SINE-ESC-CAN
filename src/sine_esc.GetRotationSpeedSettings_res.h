...
#define SINE_ESC_GETROTATIONSPEEDSETTINGS_RESPONSE_MAX_SIZE 33
#define SINE_ESC_GETROTATIONSPEEDSETTINGS_RESPONSE_SIGNATURE (0x4461BB2B55B3F410ULL)
#define SINE_ESC_GETROTATIONSPEEDSETTINGS_RESPONSE_ID 212

#if defined(__cplusplus) && defined(DRONECAN_CXX_WRAPPERS)
class sine_esc_GetRotationSpeedSettings_cxx_iface;
#endif

struct sine_esc_GetRotationSpeedSettingsResponse {
#if defined(__cplusplus) && defined(DRONECAN_CXX_WRAPPERS)
    using cxx_iface = sine_esc_GetRotationSpeedSettings_cxx_iface;
#endif
    uint16_t recv_pwm;
    uint16_t comm_pwm;
    int32_t speed;
...
static inline void _sine_esc_GetRotationSpeedSettingsResponse_encode(uint8_t* buffer, uint32_t* bit_ofs, struct sine_esc_GetRotationSpeedSettingsResponse* msg, bool tao);
static inline bool _sine_esc_GetRotationSpeedSettingsResponse_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct sine_esc_GetRotationSpeedSettingsResponse* msg, bool tao);
void _sine_esc_GetRotationSpeedSettingsResponse_encode(uint8_t* buffer, uint32_t* bit_ofs, struct sine_esc_GetRotationSpeedSettingsResponse* msg, bool tao) {
    (void)buffer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
...
/*
 decode sine_esc_GetRotationSpeedSettingsResponse, return true on failure, false on success
*/
bool _sine_esc_GetRotationSpeedSettingsResponse_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct sine_esc_GetRotationSpeedSettingsResponse* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
