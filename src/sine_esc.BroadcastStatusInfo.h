...
#define SINE_ESC_BROADCASTSTATUSINFO_MAX_SIZE 31
#define SINE_ESC_BROADCASTSTATUSINFO_SIGNATURE (0x650289817698E879ULL)
#define SINE_ESC_BROADCASTSTATUSINFO_ID 20020

#if defined(__cplusplus) && defined(DRONECAN_CXX_WRAPPERS)
class sine_esc_BroadcastStatusInfo_cxx_iface;
#endif

struct sine_esc_BroadcastStatusInfo {
#if defined(__cplusplus) && defined(DRONECAN_CXX_WRAPPERS)
    using cxx_iface = sine_esc_BroadcastStatusInfo_cxx_iface;
#endif
    uint16_t recv_pwm;
    uint16_t comm_pwm;
    int32_t speed;
...
uint32_t sine_esc_BroadcastStatusInfo_encode(struct sine_esc_BroadcastStatusInfo* msg, uint8_t* buffer
#if CANARD_ENABLE_TAO_OPTION
    , bool tao
#endif
);
bool sine_esc_BroadcastStatusInfo_decode(const CanardRxTransfer* transfer, struct sine_esc_BroadcastStatusInfo* msg);

#if defined(CANARD_DSDLC_INTERNAL)
static inline void _sine_esc_BroadcastStatusInfo_encode(uint8_t* buffer, uint32_t* bit_ofs, struct sine_esc_BroadcastStatusInfo* msg, bool tao);
static inline bool _sine_esc_BroadcastStatusInfo_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct sine_esc_BroadcastStatusInfo* msg, bool tao);
void _sine_esc_BroadcastStatusInfo_encode(uint8_t* buffer, uint32_t* bit_ofs, struct sine_esc_BroadcastStatusInfo* msg, bool tao) {
    (void)buffer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
...
/*
 decode sine_esc_BroadcastStatusInfo, return true on failure, false on success
*/
bool _sine_esc_BroadcastStatusInfo_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct sine_esc_BroadcastStatusInfo* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
...
struct sine_esc_BroadcastStatusInfo sample_sine_esc_BroadcastStatusInfo_msg(void);
#endif
#ifdef __cplusplus
} // extern "C"
...
BROADCAST_MESSAGE_CXX_IFACE(sine_esc_BroadcastStatusInfo, SINE_ESC_BROADCASTSTATUSINFO_ID, SINE_ESC_BROADCASTSTATUSINFO_SIGNATURE, SINE_ESC_BROADCASTSTATUSINFO_MAX_SIZE);
#endif
#endif
